# noticias_isfas14_.py
# v20.5 - Código completo con todas las fuentes y manejo de certificados SSL
...
# ==========================================
# DICCIONARIO MAESTRO COMPLETO DE FEEDS - ISFAS
# ==========================================
FEEDS = {
    "BOE - Búsqueda General ISFAS (Todo)": "https://news.google.com/rss/search?q=site:boe.es+ISFAS&hl=es&gl=ES&ceid=ES:es",
    "BOE - Mutualidades y ISFAS": "https://news.google.com/rss/search?q=site:boe.es+ISFAS+MUFACE&hl=es&gl=ES&ceid=ES:es",
    ...
    "Boletin Oficial de Defensa BOD": "https://news.google.com/rss/search?q=BOD+%22Boletin+Oficial+de+Defensa%22+site:defensa.gob.es&hl=es&gl=ES&ceid=ES:es",
    ...
    "INGESA - Noticias y Actualidad": "https://news.google.com/rss/search?q=ingesa+noticias+sanidad&hl=es&gl=ES&ceid=ES:es",
    "Seguridad Social - Instituto Nacional (INSS)": "https://news.google.com/rss/search?q=site:seg-social.es+INSS+prestaciones&hl=es&gl=ES&ceid=ES:es",
    "AEMPS - Notas Informativas": "https://news.google.com/rss/search?q=site:aemps.gob.es+nota+informativa&hl=es&gl=ES&ceid=ES:es",
    "AEMPS - Alertas de Medicamentos": "https://news.google.com/rss/search?q=site:aemps.gob.es+alerta+medicamentos&hl=es&gl=ES&ceid=ES:es",
    "AEMPS - Noticias y Actualidad General": "https://news.google.com/rss/search?q=site:aemps.gob.es+noticias&hl=es&gl=ES&ceid=ES:es",
    "Mutualidades y Seguridad Social": "https://news.google.com/rss/search?q=ISFAS+MUFACE+Seguridad+Social+prestaciones&hl=es&gl=ES&ceid=ES:es",
    "ABC - ISFAS y Mutualidades": "https://news.google.com/rss/search?q=site:abc.es+ISFAS+MUFACE&hl=es&gl=ES&ceid=ES:es",
    "El País - ISFAS y Sanidad": "https://news.google.com/rss/search?q=site:elpais.com+ISFAS+sanidad&hl=es&gl=ES&ceid=ES:es",
    "El Mundo - Mutualidades Defensa": "https://news.google.com/rss/search?q=site:elmundo.es+ISFAS+MUFACE&hl=es&gl=ES&ceid=ES:es",
    "La Razón - ISFAS Militar": "https://news.google.com/rss/search?q=site:larazon.es+ISFAS+militar&hl=es&gl=ES&ceid=ES:es",
    "Europa Press - ISFAS Actualidad": "https://news.google.com/rss/search?q=site:europapress.es+ISFAS+MUFACE&hl=es&gl=ES&ceid=ES:es",
    "La Voz de Galicia - ISFAS": "https://news.google.com/rss/search?q=site:lavozdegalicia.es+ISFAS+MUFACE&hl=es&gl=ES&ceid=ES:es",
    "El Periódico de Aragón - ISFAS": "https://news.google.com/rss/search?q=site:elperiodicodearagon.com+ISFAS&hl=es&gl=ES&ceid=ES:es",
    "La Verdad de Murcia - ISFAS": "https://news.google.com/rss/search?q=site:laverdad.es+ISFAS+MUFACE&hl=es&gl=ES&ceid=ES:es",
    "Ideal Andalucía - ISFAS": "https://news.google.com/rss/search?q=site:ideal.es+ISFAS+militar&hl=es&gl=ES&ceid=ES:es",
    "El Diario Montañés - ISFAS": "https://news.google.com/rss/search?q=site:eldiariomontanes.es+ISFAS&hl=es&gl=ES&ceid=ES:es",
    "Heraldo de Aragón - ISFAS": "https://news.google.com/rss/search?q=site:heraldo.es+ISFAS+sanidad&hl=es&gl=ES&ceid=ES:es",
    "Las Provincias (Valencia) - ISFAS": "https://news.google.com/rss/search?q=site:lasprovincias.es+ISFAS+MUFACE&hl=es&gl=ES&ceid=ES:es"
}
...
def obtener_noticias():
    ...
    # Contexto SSL para evitar errores de certificados en fuentes externas
...
<body>
    ...
    <script>
        ...
        function copiarParaEmail() {{
            ...
            let htmlSnippet = '<div style="font-family: Montserrat, Arial, sans-serif; color: #2d3748; max-width: 900px; margin: 0 auto; background-color: #f7fafc; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden;">';
            
            htmlSnippet += '<div style="background: linear-gradient(135deg, #1a365d 0%, #2c5282 100%); color: #ffffff; padding: 30px 20px; text-align: center; border-bottom: 4px solid #3182ce;">';
            htmlSnippet += '<h1 style="margin: 0; font-size: 24px; font-weight: 700; letter-spacing: 2px; text-transform: uppercase;">ISFAS</h1>';
            htmlSnippet += '<div style="margin-top: 6px; font-size: 14px; font-weight: 400; color: #e2e8f0; letter-spacing: 1px;">OFICINA DE COMUNICACIÓN</div>';
            htmlSnippet += '<div style="display: inline-block; margin-top: 12px; background-color: rgba(255, 255, 255, 0.15); padding: 5px 14px; border-radius: 20px; font-size: 13px; font-weight: 600; border: 1px solid rgba(255, 255, 255, 0.2); color: #ffffff;">' + fechaTexto + '</div>';
            htmlSnippet += '</div>';

            htmlSnippet += '<div style="padding: 25px 20px;">';
            ...
            seleccionados.forEach(item => {{
                ...
                htmlSnippet += '<div style="background: #ffffff; border-left: 5px solid #3182ce; border-top: 1px solid #edf2f7; border-right: 1px solid #edf2f7; border-bottom: 1px solid #edf2f7; padding: 16px 20px; margin-bottom: 15px; border-radius: 8px;">';
                htmlSnippet += '<div style="margin-bottom: 8px;">';
                htmlSnippet += '<span style="font-size: 11px; font-weight: bold; padding: 4px 8px; border-radius: 4px; background: #ebf8ff; color: #2b6cb0; text-transform: uppercase;">' + item.categoria + '</span>';
                htmlSnippet += '<span style="font-size: 12px; color: #718096; float: right;">🕒 ' + item.fecha_str + '</span>';
                htmlSnippet += '</div>';
                htmlSnippet += '<div style="font-size: 16px; font-weight: 600; margin: 10px 0 6px 0; line-height: 1.4;">';
                htmlSnippet += '<a href="' + item.enlace + '" target="_blank" style="color: #2d3748; text-decoration: none;">' + item.titulo + '</a>';
                htmlSnippet += '</div>';
                htmlSnippet += '<div style="font-size: 12px; color: #718096;">📍 Fuente: <strong>' + item.fuente + '</strong></div>';
                htmlSnippet += '</div>';
            ...
            htmlSnippet += '<div style="background-color: #2c5282; color: #ffffff; text-align: center; padding: 18px; font-size: 14px; font-weight: 600; letter-spacing: 0.5px; line-height: 1.5;">';
            htmlSnippet += '@ISFAS - Instituto Social de las Fuerzas Armadas';
            htmlSnippet += '<span style="color: #cbd5e0; font-weight: 400; display: block; font-size: 12px; margin-top: 4px;">Oficina de Comunicación - Capitán de Corbeta Fran Lozano</span>';
            htmlSnippet += '</div>';
            ...
            if (navigator.clipboard && window.ClipboardItem) {{
                ...
                navigator.clipboard.write(data).then(() => {{
                    alert('¡Bloque copiado al portapapeles! Recuerda guardar el archivo historial_enviadas.json actualizado.');
                }}).catch(err => {{
...
def main():
    print("⏳ Descargando noticias desde los RSS...")
